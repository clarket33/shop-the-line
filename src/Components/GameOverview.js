            ...
            <CardBody className="text-center">
                ...
                <div className="hidden lg:block">
                    ...
                    <Typography  variant="h6" color="blue-gray" className="font-medium" textGradient>
                        ...
                        {isLive ? <div className="flex">
                            <div className={game.sport !== "americanfootball_ncaaf" ? "w-4/12 text-right m-auto":"w-5/12 text-center m-auto"}>{game.curScore?<span>{game.curScore[0].name === game.awayTeam ? game.curScore[0].score : game.curScore[1].score}</span>:<></>}</div>
                            ...
                            <div className={game.sport !== "americanfootball_ncaaf" ? "w-4/12 text-left m-auto":"w-5/12 text-center m-auto"}>{game.curScore?<span>{game.curScore[0].name === game.homeTeam ? game.curScore[0].score : game.curScore[1].score}</span>:<></>}</div>
