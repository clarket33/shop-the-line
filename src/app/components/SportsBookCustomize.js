import {bookmaker_names} from '../lib/Resources.js';
    ...
    <div className="flex w-full min-w-[120px] h-10">
        ...
        isRequired: {}   
            ...
            <MenuHandler>
                    ...
                    <Button variant="text" size="sm" color="blue-gray" className="flex gap-2 items-center justify-center font-medium text-blue-gray-500 w-full border border-blue-gray-200">
                        SPORTSBOOKS
                        <ChevronDownIcon
                            strokeWidth={2.5}
