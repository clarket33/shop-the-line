...
export default function Policy(policy) {
    ...
    function PrivacyPolicy(){
        return (<div>
            ...
            Google, as a third-party vendor, uses cookies to serve ads on our website. Google&lsquo;s use of the advertising cookie enables it and its partners to serve ads to our users based on their visit to our site and/or other sites on the internet.
            ...
            <p>Our website may contain links to other websites that are not operated by us. If you click on a third-party link, you will be directed to that third party&lsquo;s website. We strongly advise you to review the privacy policy of every website you visit.
