            ...
            allowHover={true}>
                <MenuHandler>
                        ...
                        <Button variant="text" size="lg" className="flex gap-2 items-center justify-center font-medium text-blue-gray-500 w-full">
                                {league_titles[sport]}
                                <Image  className="object-cover grayscale" width={16} height={16} src={`/Images/Sports/${sport}.png`} alt={sport} />
                            <ChevronDownIcon
                                strokeWidth={2.5}
                        ...
                        {menuItems.map((category) => {
                            return <div className="mx-auto items-center w-24" key={category["category"]}>
                                    ...
                                    <div className="mx-auto flex items-center">
                                        ...
                                        <Image className="object-cover ml-1 grayscale" width={16} height={16} src={`/Images/Sports/${category["subcategories"][0]["name"]}.png`} alt={category["category"]} />
                                    </div>
                                    </Typography>
                                    <div>
